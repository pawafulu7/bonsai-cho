...
const speciesData = [
  {
    ...
    description:
      "日本の盆栽で最も人気のある樹種の一つ。力強い幹と緑の針葉が特徴。",
  },
  {
    ...
    description: "優美な針葉と美しい樹皮が特徴。文人木によく使われる。",
  },
  {
    id: "species_shimpaku",
    nameJa: "真柏",
    ...
    description: "柔軟性がありジン・シャリの表現に優れる。懸崖仕立てに人気。",
  },
  {
    id: "species_kaede",
    nameJa: "楓",
    ...
    description: "美しい紅葉と繊細な葉が魅力。秋の彩りが格別。",
  },
  {
    id: "species_keyaki",
    nameJa: "欅",
    ...
    description: "箒作りの定番。細かい枝の充実が見どころ。",
  },
  {
    id: "species_ume",
    nameJa: "梅",
    ...
    description: "早春の芳香ある花と古木の趣きある幹が魅力。",
  },
  {
    id: "species_sakura",
    nameJa: "桜",
  ...
  },
  {
    ...
    description: "初夏の鮮やかな花が特徴。多彩な花色が楽しめる。",
  },
];
...
const stylesData = [
  {
    ...
    description:
      "真っ直ぐな幹とバランスの取れた枝配り。頂点に向かって細くなる。",
  },
  {
    id: "style_moyogi",
    nameJa: "模様木",
    nameEn: "Informal Upright",
    description: "S字カーブの幹と自然な流れが特徴。最も一般的な樹形。",
  },
  {
    id: "style_shakan",
    nameJa: "斜幹",
    nameEn: "Slanting",
    description: "幹が斜めに傾いた樹形。風や環境の影響を表現。",
  },
  {
    id: "style_kengai",
    nameJa: "懸崖",
    nameEn: "Cascade",
    description: "幹が鉢の底より下に垂れ下がる。崖に生える木を表現。",
  },
  {
    id: "style_han_kengai",
    nameJa: "半懸崖",
    nameEn: "Semi-Cascade",
    description: "幹が垂れ下がるが鉢の底より上に留まる。懸崖より穏やか。",
  },
  {
    id: "style_bunjingi",
    nameJa: "文人木",
    nameEn: "Literati",
    description: "枝を最小限に抑えた優雅で高い幹。中国文人画に着想。",
  },
  {
    id: "style_fukinagashi",
    nameJa: "吹き流し",
    nameEn: "Windswept",
    description: "全ての枝が一方向に流れる。常に吹く風を表現。",
  },
  {
    id: "style_hokidachi",
    nameJa: "箒作り",
    nameEn: "Broom",
    description: "放射状に広がる細い枝が箒のような樹冠を形成。落葉樹に多い。",
  },
  {
    id: "style_yose_ue",
    nameJa: "寄せ植え",
    nameEn: "Forest/Group Planting",
    description: "複数の木を植えて森の風景を表現。",
  },
  {
    id: "style_ishitsuki",
    nameJa: "石付き",
    nameEn: "Root Over Rock",
    description: "根が岩を覆い、その表面を掴む。自然の厳しさを表現。",
  },
];
